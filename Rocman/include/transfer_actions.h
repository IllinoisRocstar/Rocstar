...
class InterMeshTransfer : public RocstarAction {
 public:
  explicit InterMeshTransfer(int n, FluidAgent *fag, SolidAgent *sag, char *name = NULL);
 protected:
...
class LoadTransfer_FS : public InterMeshTransfer {
 public:
  explicit LoadTransfer_FS(FluidAgent *fag,
                           SolidAgent *sag,
...
class LoadTransfer_FSc_ALE : public InterMeshTransfer {
 public:
  explicit LoadTransfer_FSc_ALE(FluidAgent *fag,
                                SolidAgent *sag,
                                BurnAgent *bag,
...
class LoadTransferOnly_FSc_ALE : public InterMeshTransfer {
 public:
  explicit LoadTransferOnly_FSc_ALE(FluidAgent *fag,
                                    SolidAgent *sag,
                                    BurnAgent *bag,
                                    const std::string f_ts,
                                    const std::string s_ts,
...
class GetDeformedMesh : public InterMeshTransfer {
 public:
  explicit GetDeformedMesh(FluidAgent *fag,
                           SolidAgent *sag,
...
class GetDeformedMesh_ALE : public InterMeshTransfer {
 public:
  explicit GetDeformedMesh_ALE(FluidAgent *fag,
                               SolidAgent *sag,
                               const std::string s_x,
                               const std::string uhat,
                               const std::string s_y,
...
class MeshMotionTransfer_SF : public InterMeshTransfer {
 public:
  explicit MeshMotionTransfer_SF(FluidAgent *fag,
                                 SolidAgent *sag,
...
class DeformationVelTransfer_SF : public InterMeshTransfer {
 public:
  explicit DeformationVelTransfer_SF(FluidAgent *fag,
                                     SolidAgent *sag,
...
class MeshMotionTransferISS : public InterMeshTransfer {
 public:
  explicit MeshMotionTransferISS(FluidAgent *fag,
                                 SolidAgent *sag,
                                 const std::string s_u,
                                 const std::string s_vs,
                                 const std::string f_vm
...
class RemeshInit : public InterMeshTransfer {
 public:
  explicit RemeshInit(FluidAgent *fag,
                      SolidAgent *sag,
                      const std::string s_u,
                      const std::string f_total_disp,
...
#define DECLARE_NEW_ACTION(ActionName)                                         \
  ...
  public:                                                                      \
    explicit ActionName(FluidAgent *fag, SolidAgent *sag, const char *at[],    \
                        int *is = NULL, void *p = NULL);                       \
    void init(double t);                                                       \
    void run(double t, double dt, double alpha);                               \
  }
