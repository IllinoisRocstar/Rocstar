...
SetValueDouble::SetValueDouble(const std::string at, const double val) :
    RocstarAction(1, &at, NULL, NULL, (char *) "SetValueDouble"), v(val) {
...
SetZero::SetZero(const std::string at) : SetValueDouble(at, 0) { action_name = (char *) "SetZero"; }

CopyValue::CopyValue(const std::string from, const std::string to, bool cond) :
    RocstarAction(2, (const char **) NULL, NULL, NULL, (char *) "CopyValue"), condition(cond) {
  // Define I/O of the arguments.
  int io[] = {IN, OUT};
  set_io(2, io);
...
DummyPrint::DummyPrint(BurnAgent *bag, SolidAgent *sag, FluidAgent *fag, const std::string l) :
    RocstarAction(0, (const char **) NULL, NULL, NULL, (char *) "DummyPrint"),
...
BCInvoker::BCInvoker(RocstarAgent *ag, int l) :
    RocstarAction(0, (const char **) NULL, NULL, NULL, (char *) "BCInvoker"),
    agent(ag), level(l) {
  set_io(0, NULL);
  set_attr(0, (const char **) NULL);
}
...
GMInvoker::GMInvoker(RocstarAgent *ag) :
    RocstarAction(0, (const char **) NULL, NULL, NULL, (char *) "GMInvoker"),
    agent(ag) {
  set_io(0, NULL);
  set_attr(0, (const char **) NULL);
}
...
BCInitInvoker::BCInitInvoker(RocstarAgent *ag) :
    RocstarAction(0, (const char **) NULL, NULL, NULL, (char *) "BCInitInvoker"),
    agent(ag) {
  set_io(0, NULL);
  set_attr(0, (const char **) NULL);
}
...
ComputeFluidLoad_ALE::ComputeFluidLoad_ALE(FluidAgent *fag, SolidAgent *sag,
    ...
    RocstarAction(4, (const char **) NULL, NULL, NULL, (char *) "ComputeFluidLoad_ALE"),
...
ComputeMeshMotion::ComputeMeshMotion(FluidAgent *ag,
    ...
    RocstarAction(2, (const char **) NULL, NULL, NULL, (char *) "ComputeMeshMotion"),
    fagent(ag), zoom(z) {
  int io[] = {IN, OUT};
  set_io(2, io);
...
void ComputeMeshMotion::init(double t) {
  ...
  f_du_alp_hdl = COM_get_dataitem_handle(fagent->get_surface_window() + action_data[1].attr);
...
ComputeFaceCenters::ComputeFaceCenters(BurnAgent *ag, const std::string b_nc, const std::string b_cnts,
    ...
    RocstarAction(3, (const char **) NULL, NULL, NULL, (char *) "ComputeFaceCenters"), agent(ag) {
  int io[] = {IN, OUT, OUT};
  set_io(3, io);
...
//  agent->obtain_bc(&zero);
  ...
  if (b_cnts_hdl >= 0 || b_nrml_hdl >= 0) {
    load_rocsurf();
    MAN_DEBUG(3,
              ("Rocstar: ComputeFaceCenters::run() with t:%e dt:%e b_cnts_hdl:%d b_nrml_hdl:%d.\n", t, dt, b_cnts_hdl, b_nrml_hdl));
    if (b_cnts_hdl >= 0) {
      SURF_n2f = COM_get_function_handle("SURF.interpolate_to_centers");
...
FluidPropagateSurface::FluidPropagateSurface(FluidAgent *fag, BurnAgent *bag,
    ...
    RocstarAction(2, (const char **) NULL, NULL, NULL, (char *) "FluidPropagateSurface"), fagent(fag), bagent(bag), zoom(z) {
  int io[] = {IN, OUT};
  set_io(2, io);
...
void FluidPropagateSurface::init(double t) {
  ...
  load_rocprop(fagent->get_rocstar_coupling()->get_rocmancontrol_param(), fagent->get_communicator());
  load_rocon(fagent->get_rocstar_coupling()->get_rocmancontrol_param(), fagent->get_communicator());
...
void FluidPropagateSurface::run(double t, double dt, double alpha_dummy) {
  if (zoom <= 0.0 || fagent->get_coupling()->is_initial_start()) return;
  ...
  const RocmanControl_parameters *param = fagent->get_rocstar_coupling()->get_rocmancontrol_param();
...
MassTransfer::MassTransfer(FluidAgent *fag, BurnAgent *bag,
    ...
    RocstarAction(3, (const char **) NULL, NULL, NULL, (char *) "MassTransfer"),
...
ZoomInterface::ZoomInterface(FluidAgent *fag, BurnAgent *bag,
    ...
    RocstarAction(1, (const char **) NULL, NULL, NULL, (char *) "ZoomInterface"),
...
ComputeRhofvf::ComputeRhofvf(FluidAgent *fag, std::string f_vs_alp, std::string f_rhof_alp, std::string f_rhofvf_alp) :
    RocstarAction(3, (const char **) NULL, NULL, NULL, (char *) "ComputeRhofvf"),
    fagent(fag) {
  int io[] = {IN, IN, OUT};
  set_io(3, io);
...
ComputeBurnPane::ComputeBurnPane(FluidAgent *fag, BurnAgent *bag,
    ...
    RocstarAction(2, (const char **) NULL, NULL, NULL, (char *) "ComputeBurnPane"),
...
CopyBurnFromParentMesh::CopyBurnFromParentMesh(BurnAgent *bag, FluidAgent *fag) :
    RocstarAction(0, (const char **) NULL, NULL, NULL, (char *) "CopyBurnFromParentMesh"),
...
void CopyBurnFromParentMesh::init(double t) {
  ...
  MAN_DEBUG(3,
            ("Rocstar: CopyBurnFromParentMesh::init() with t:%e %s  %s.\n", t, burn_mesh.c_str(), parent_mesh.c_str()));
}
...
CopyBflagFromBurn::CopyBflagFromBurn(BurnAgent *bag) :
    RocstarAction(0, (const char **) NULL, NULL, NULL, (char *) "CopyBflagFromBurn"),
    bagent(bag) {
  set_io(0, (int *) NULL);
...
void CopyBflagFromBurn::run(double t, double dt, double alpha_dummy) {
  ...
  if (!bagent->get_coupling()->is_initial_start() &&
      (bagent->ignmodel || t == bagent->get_rocstar_coupling()->get_control_param()->init_time)) {
...
// POST_INIT_FLUID
ComputePconn::ComputePconn(RocstarAgent *ag, std::string a_mesh, std::string a_pconn, std::string p_pmesh, bool cond) :
    RocstarAction(3, (const char **) NULL, NULL, NULL, (char *) "ComputePconn"),
    agent(ag), a_mesh_str(a_mesh), a_pconn_str(a_pconn), p_pmesh_str(p_pmesh), condition(cond) {
...
void ComputePconn::init(double t) {
  ...
  load_rocprop(agent->get_rocstar_coupling()->get_rocmancontrol_param(), agent->get_communicator());
...
SolidPropagateSurface_ALE::SolidPropagateSurface_ALE(SolidAgent *fag,
    ...
    RocstarAction(2, (const char **) NULL, NULL, NULL, (char *) "SolidPropagateSurface"),
    sagent(fag), zoom(z) {
  int io[] = {IN, OUT};
  set_io(2, io);
...
void SolidPropagateSurface_ALE::init(double t) {
  ...
  int PROP_fom = sagent->get_rocstar_coupling()->get_rocmancontrol_param()->PROP_fom;
  ...
  load_rocprop(sagent->get_rocstar_coupling()->get_rocmancontrol_param(), sagent->get_communicator());
  load_rocon(sagent->get_rocstar_coupling()->get_rocmancontrol_param(), sagent->get_communicator());
  PROP_propagate = COM_get_function_handle("PROP.propagate");
  if (COM_get_window_handle("PROPCON") >= 0) {
    PROPCON_find_intersections = COM_get_function_handle("PROPCON.find_intersections");
    PROPCON_constrain_displacements = COM_get_function_handle("PROPCON.constrain_displacements");
...
Reset_du_alp::Reset_du_alp(FluidAgent *fag) :
    RocstarAction(0, (const char **) NULL, NULL, NULL, (char *) "Reset_du_alp"), fagent(fag) {
  // Define I/O of the arguments.
  set_io(0, NULL);
  set_attr(0, (const char **) NULL);
}
