...
namespace Rocstar{
  ...
  int Test(int argc,char *argv[])
  {
    ...
    if(!comline.GetOption("help").empty()){
      ...
      if(verblevel > 2)
        std::cout << "Rocstar::Test: Exiting test function (success)" << std::endl;
      return(0);
    }
    if(clerr){
      ...
      if(verblevel > 2)
        std::cout << "Rocstar::Test: Exiting test function (fail)" << std::endl;
      return(1);
    }
    ...
    if(!OutFileName.empty()){
      ...
      if(!Ouf){
        std::cout << "Rocstar::Test> Error: Could not open output file, " 
    ...
    if(verblevel > 2)
      std::cout << "Rocstar::Test: Entering test function" << std::endl;
    
    // Make an instance of the Rocstar testing object, Rocstar::TestingObject
    Rocstar::TestingObject<Rocstar::TestResults> test;
    ...
    // run the listed tests.
      ...
      if(!ListInf){
        std::cout << "Rocstar::Test> Error: Could not open list of tests in file " 
    ...
    *Out << results << std::endl;
    ...
    if(verblevel > 2)
      *Out << "Rocstar::Test: Exiting test function (success)" << std::endl;
