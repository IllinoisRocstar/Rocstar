 ...
 *********************************************************************/
// $Id: Rocmop.h,v 1.4 2008/12/06 08:45:24 mtcampbe Exp $
...
protected:
   ...
   *
   *  \param pre_quality pre-smoothed mesh quality or the worst quality possible 
   *  if not in lazy or monotone mode.
   */
   ...
   *  quality is achieved.
   *  
   * \param pre_quality see perform_smoothing()
   */
...
protected: // Variables not currently modifiable via set_option
   ...
   COM::Window                 *_wrk_window;          ///< The working window
 ...
 protected: // Variables which can be modified via set option.
  ...
  // 0 = no debugging info
   ...
   int _monotone; ///< Impose non-decreasing quality?
