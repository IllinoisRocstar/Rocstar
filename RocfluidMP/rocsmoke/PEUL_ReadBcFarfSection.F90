...
!******************************************************************************
!
! Purpose: read in user input related to far field boundary condition for
!          Eulerian particles
!
! Description: none.
!
...
!******************************************************************************
!
! $Id: PEUL_ReadBcFarfSection.F90,v 1.4 2008/12/06 08:44:39 mtcampbe Exp $
!
...
!******************************************************************************
  ...
  RCSIdentString = &
    '$RCSfile: PEUL_ReadBcFarfSection.F90,v $ $Revision: 1.4 $'

  global => regions(1)%global

  CALL RegisterFunction( global,'PEUL_ReadBcFarfSection',&
...
!
! $Log: PEUL_ReadBcFarfSection.F90,v $
...
!
! Revision 1.2  2006/08/19 15:40:22  mparmar
! Renamed patch variables
!
! Revision 1.1  2004/12/01 21:09:39  haselbac
...
!
! Revision 1.3  2003/03/04 19:26:46  jferry
