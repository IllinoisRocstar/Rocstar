...
!******************************************************************************
!
! $Id: RFLU_WriteVersionString.F90,v 1.3 2008/12/06 08:44:30 mtcampbe Exp $
!
...
#ifndef CHARM
  moduleString = 'rflump'
  iFileName    = TRIM(global%outDir)//'rflump.vrs'  
#else
  moduleString = 'rflump_charm'
  iFileName    = TRIM(global%outDir)//'rflump_charm.vrs'    
#endif 
...
!
! Revision 1.1  2003/03/31 16:06:12  haselbac
! Initial revision
!
! ******************************************************************************
