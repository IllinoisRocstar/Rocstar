...
!******************************************************************************
!
! $Id: RFLU_WriteVersionString.F90,v 1.5 2008/12/06 08:44:55 mtcampbe Exp $
!
...
! ******************************************************************************
  ...
  RCSIdentString = '$RCSfile: RFLU_WriteVersionString.F90,v $ $Revision: 1.5 $'
...
! ******************************************************************************
  ...
  moduleString = 'rfluconv'
  iFileName    = TRIM(global%outDir)//'rfluconv.vrs'    
...
! Revision 1.5  2008/12/06 08:44:55  mtcampbe
! Updated license.
!
! Revision 1.4  2008/11/19 22:18:05  mtcampbe
! Added Illinois Open Source License/Copyright
!
! Revision 1.3  2004/03/19 21:23:49  haselbac
! Fixed bug in moduleString
!
! Revision 1.2  2003/03/31 20:03:48  haselbac
! Removed Charm stuff and fixed bug in string
!
! Revision 1.1  2003/03/31 16:09:30  haselbac
! Initial revision
!
! ******************************************************************************
