...
! ******************************************************************************
!
! $Id: RFLU_PrintHeader.F90,v 1.7 2008/12/06 08:44:55 mtcampbe Exp $
!
...
! ==============================================================================
  ...
  WRITE(STDOUT,'(A,1X,A)') SOLVER_NAME,'                                      '
  WRITE(STDOUT,'(A,1X,A)') SOLVER_NAME,'              rfluconv                '
  WRITE(STDOUT,'(A,1X,A)') SOLVER_NAME,'                                      '
...
! Revision 1.7  2008/12/06 08:44:55  mtcampbe
! Updated license.
!
! Revision 1.6  2008/11/19 22:18:05  mtcampbe
! Added Illinois Open Source License/Copyright
!
! Revision 1.5  2005/05/03 03:08:34  haselbac
! Changed header
!
! Revision 1.4  2004/12/02 15:27:22  haselbac
! Added printing of module version strings, cosmetics
!
! Revision 1.3  2003/11/25 21:01:05  haselbac
