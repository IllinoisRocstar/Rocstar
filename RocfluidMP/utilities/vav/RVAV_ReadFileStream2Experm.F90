...
!******************************************************************************
!
! Purpose: read File for Stream 2 Data for Experimental Solutions.
!
! Description: none.
!
! Input: 
...
!******************************************************************************
!
! $Id: RVAV_ReadFileStream2Experm.F90,v 1.3 2008/12/06 08:45:08 mtcampbe Exp $
!
...
! open file
  ...
  IF ( globalRVAV%fileTypeS2 == FILE_EXPERIMENTAL) THEN
    WRITE(fname,'(A,I5.5)') TRIM(global%casename)//'.exp'
  ENDIF ! fileTypeS2
...
!
! $Log: RVAV_ReadFileStream2Experm.F90,v $
...
!
! Revision 1.1  2002/07/16 22:35:14  f-najjar
! Initial Import
!
!
!******************************************************************************
