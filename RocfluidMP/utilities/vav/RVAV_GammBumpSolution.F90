...
!******************************************************************************
!
! Purpose: Generate Analytical DataStream for GAMM Bump.
!
! Description: 
!
! Input: number of variables, extents 
!
...
!******************************************************************************
!
! $Id: RVAV_GammBumpSolution.F90,v 1.3 2008/12/06 08:45:08 mtcampbe Exp $
!
...
! ... local variables
  ...
  REAL(RFREAL), PARAMETER :: pressureTot = 1.0E+05_RFREAL
...
! - allocate work array
    ...
    ALLOCATE( cvSA(1,ibc:iec) ,stat=errorFlag )
...
!
! $Log: RVAV_GammBumpSolution.F90,v $
...
!
! Revision 1.1  2004/12/01 22:43:23  fnajjar
...
!
! Revision 1.1  2002/07/31 02:36:24  f-najjar
! Initial Import
!
!
!******************************************************************************
