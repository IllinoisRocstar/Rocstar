...
! ******************************************************************************
!
! Purpose: correct cell2face averaging coeffs. in degenerated edges/corners.
!
! Description: as the e/c is practically no exist, no real coordinates are 
!              available, hence the 2 point coefficients are set to 0.5.
!
! Notes: none.
!
! ******************************************************************************
!
! $Id: RFLO_C2fAvgCoeffsDegec.F90,v 1.3 2008/12/06 08:44:25 mtcampbe Exp $
!
...
! ******************************************************************************
  ...
  CALL RegisterFunction(global,'RFLO_C2fAvgCoeffsDegec',&
...
!
! $Log: RFLO_C2fAvgCoeffsDegec.F90,v $
