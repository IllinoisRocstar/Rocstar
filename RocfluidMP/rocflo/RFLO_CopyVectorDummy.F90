...
!******************************************************************************
!
! Purpose: copy a vector from the boundary cells to the dummy cells.
!
! Description: file contains the following subroutines:
!
!  - RFLO_copyVectorPatches = copy for patches
!  - RFLO_copyVectorEdges   = copy for edge cells
!  - RFLO_copyVectorCorners = copy for corner cells
!
! Input: iLev   = grid level
!        region = dimensions of current region
!        vec    = data to be copied
!
! Output: vec = data copied to dummy cells.
!
! Notes: no averaging is done. Thus, these routines are primarily intended to
!        copy geometrical quantities rather than flow variables. Copying is
!        conducted for all edge and corner cells, independent of their
!        connection to other regions. Routines are used now to copy the
!        volumes and the time step.
!
!******************************************************************************
!
! $Id: RFLO_CopyVectorDummy.F90,v 1.3 2008/12/06 08:44:26 mtcampbe Exp $
!
...
!
! $Log: RFLO_CopyVectorDummy.F90,v $
