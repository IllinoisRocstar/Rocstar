...
! ******************************************************************************
!
! $Id: RFLU_OpenRestartInfo.F90,v 1.6 2008/12/06 08:44:12 mtcampbe Exp $
!
...
! *****************************************************************************
  ...
  RCSIdentString = '$RCSfile: RFLU_OpenRestartInfo.F90,v $ $Revision: 1.6 $'

  CALL RegisterFunction(global,'RFLU_OpenRestartInfo',&
