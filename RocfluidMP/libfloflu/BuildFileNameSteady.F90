...
!   directory, case name, extension, domain id, and iteration counter.
!
! Description: None.
!
! Input: 
...
!******************************************************************************
!
! $Id: BuildFileNameSteady.F90,v 1.4 2008/12/06 08:44:08 mtcampbe Exp $
!
...
! ******************************************************************************
  ...
  RCSIdentString = '$RCSfile: BuildFileNameSteady.F90,v $ $Revision: 1.4 $'
  ...
  WRITE(fileName,'(A,A,I5.5,A,I6.6)') & 
    TRIM(destString)//TRIM(global%caseName)//TRIM(ext),'_',id,'_',it
...
!   Removed tabs
!
!   Revision 1.1  2004/12/01 16:48:11  haselbac
