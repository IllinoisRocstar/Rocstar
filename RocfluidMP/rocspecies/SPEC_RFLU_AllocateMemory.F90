...
!******************************************************************************
!
! Purpose: Allocate memory for species
!
! Description: None.
!
! Input: 
...
!******************************************************************************
!
! $Id: SPEC_RFLU_AllocateMemory.F90,v 1.4 2008/12/06 08:44:40 mtcampbe Exp $
!
...
! ******************************************************************************
  ...
  RCSIdentString = '$RCSfile: SPEC_RFLU_AllocateMemory.F90,v $ $Revision: 1.4 $'

  global => pRegion%global

  CALL RegisterFunction(global,'SPEC_RFLU_AllocateMemory',&
...
! ******************************************************************************
  ...
  CALL SPEC_RFLU_AllocateMemoryTStep(pRegion)
...
!
! $Log: SPEC_RFLU_AllocateMemory.F90,v $
