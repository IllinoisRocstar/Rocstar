...
!******************************************************************************
!
! Purpose: Read in user input related to inflow boundary condition for species.
!
! Description: None.
!
! Input: 
...
!******************************************************************************
!
! $Id: SPEC_RFLU_ReadBcInflowSection.F90,v 1.5 2008/12/06 08:44:40 mtcampbe Exp $
!
...
! *****************************************************************************
  ...
  RCSIdentString = '$RCSfile: SPEC_RFLU_ReadBcInflowSection.F90,v $ $Revision: 1.5 $'

  global => pRegion%global

  CALL RegisterFunction(global,'SPEC_RFLU_ReadBcInflowSection',&
...
!
! $Log: SPEC_RFLU_ReadBcInflowSection.F90,v $
...
!
! Revision 1.3  2006/08/19 15:40:31  mparmar
