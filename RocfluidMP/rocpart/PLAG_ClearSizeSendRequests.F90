...
!******************************************************************************
!
! $Id: PLAG_ClearSizeSendRequests.F90,v 1.3 2008/12/06 08:44:33 mtcampbe Exp $
!
...
! ... local variables
  ...
  INTEGER :: bcType, iLev, iRegDes, iRequestPlag, nPatches
...
!******************************************************************************
  ...
  RCSIdentString = '$RCSfile: PLAG_ClearSizeSendRequests.F90,v $ $Revision: 1.3 $'
...
! - region interface, periodic boundary ---------------------------------------
    ...
    IF (iRegDes > 0) THEN
      IF (doWait .AND. (regions(iRegDes)%procid /= global%myProcid)) THEN
        CALL MPI_Wait( pPlag%requests(iRequestPlag), statusPlag, global%mpierr )
...
!
! $Log: PLAG_ClearSizeSendRequests.F90,v $
...
!
! Revision 1.1  2004/12/01 20:57:24  fnajjar
! Initial revision after changing case
!
! Revision 1.1  2003/02/21 17:46:47  fnajjar
