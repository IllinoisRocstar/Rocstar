...
!******************************************************************************
!
! $Id: PLAG_CECellsClearRequestsSize.F90,v 1.3 2008/12/06 08:44:32 mtcampbe Exp $
!
...
! ******************************************************************************
  ...
  RCSIdentString = '$RCSfile: PLAG_CECellsClearRequestsSize.F90,v $ $Revision: 1.3 $'
...
! ******************************************************************************
  ...
  DO ir=1,global%nRegions
    IF (regions(iReg)%levels(iLev)%sendEcCells(ir)%nCells > 0) THEN
      ...
      CALL MPI_Wait( pPlag%requestsCECells(iRequestPlag),statusPlag, &
                     global%mpierr )
...
!
! $Log: PLAG_CECellsClearRequestsSize.F90,v $
...
!
! Revision 1.1  2004/12/01 20:57:07  fnajjar
