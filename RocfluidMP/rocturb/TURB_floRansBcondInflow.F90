...
!******************************************************************************
!
! Purpose: update RaNS variables in dummy cells at inflow boundary patch.
!
! Description: We take the first dummy solution as prescribed inflow 
!              condition, fixed in time, and update the other dummies
!              by subsequent linear extrapolations.
!
...
!******************************************************************************
!
! $Id: TURB_floRansBcondInflow.F90,v 1.4 2008/12/06 08:44:44 mtcampbe Exp $
!
...
!
! $Log: TURB_floRansBcondInflow.F90,v $
