...
!******************************************************************************
!
! Purpose: Perform face to face uniform filtering.
!
...
!******************************************************************************
!
! $Id: TURB_floLesUniFiltFF.F90,v 1.4 2008/12/06 08:44:43 mtcampbe Exp $
!
...
SUBROUTINE TURB_FloLesUniFiltFF( region,ijk,nDel,idBeg,idEnd,fVar,fbVar )
  ...
  USE TURB_ModInterfaces, ONLY : TURB_FloLesUniFiltFFI, &
                                 ...
                                 TURB_FloLesUniFiltFFK, TURB_FloExtrapolFaceVec
  USE ModTurbulence
  USE ModError
  USE ModParameters
...
!******************************************************************************
  ...
  RCSIdentString = '$RCSfile: TURB_floLesUniFiltFF.F90,v $'
...
!
! $Log: TURB_floLesUniFiltFF.F90,v $
