...
!******************************************************************************
!
! $Id: TURB_floExtrapIntCellScal.F90,v 1.4 2008/12/06 08:44:43 mtcampbe Exp $
!
...
!******************************************************************************
  ...
  RCSIdentString = '$RCSfile: TURB_floExtrapIntCellScal.F90,v $'

  global => region%global
  CALL RegisterFunction( global,'TURB_FloExtrapIntCellScal',&
...
!
! $Log: TURB_floExtrapIntCellScal.F90,v $
