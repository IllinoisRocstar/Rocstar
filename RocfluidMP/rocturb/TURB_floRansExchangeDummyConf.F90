...
!******************************************************************************
!
! Purpose: exchange RaNS variables between interior and dummy cells of the
...
!
! Output: regions%levels%turb%cv = RaNS variables in dummy cells.
!
! Notes: intended for conforming grid boundaries only.
!
!******************************************************************************
!
! $Id: TURB_floRansExchangeDummyConf.F90,v 1.4 2008/12/06 08:44:44 mtcampbe Exp $
!
...
! get dimensions and pointers
  ...
  tcvSrc => regionSrc%levels(iLev)%turb%cv
...
!
! $Log: TURB_floRansExchangeDummyConf.F90,v $
