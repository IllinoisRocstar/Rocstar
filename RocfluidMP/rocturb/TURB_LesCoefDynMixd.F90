...
!******************************************************************************
!
! Purpose: Obtain model coefficient for dynamic mixed model.
!
! Description: none.
!
...
!******************************************************************************
!
! $Id: TURB_LesCoefDynMixd.F90,v 1.7 2008/12/06 08:44:41 mtcampbe Exp $
!
...
#endif                                 
  USE TURB_ModInterfaces, ONLY : TURB_LesLij, TURB_LesHij, TURB_LesMij, &
                                 TURB_LesContract
  USE ModError
  USE ModParameters
...
!******************************************************************************
  ...
  RCSIdentString = '$RCSfile: TURB_LesCoefDynMixd.F90,v $'
...
! lesHij (ffVar,lij) and by lesContract (lij)
...
! adjust L_{ij} and subtract H_{ij} from it and store this in lij again

#ifdef RFLO
  CALL TURB_LesHij( region,ijk )
...
!
! Revision 1.5  2004/07/30 22:34:22  wasistho
! replaced floLesUniC2F by floLesGenC2F
!
! Revision 1.4  2004/05/28 02:00:50  wasistho
! update unstructured grid LES
!
! Revision 1.3  2004/03/19 02:49:12  wasistho
! prepared for RFLU
!
...
!
! Revision 1.3  2003/08/29 01:40:50  wasistho
! Added TARGET attribute to region variable, since pointers are cached into it
!
! Revision 1.2  2002/10/16 01:59:21  wasistho
