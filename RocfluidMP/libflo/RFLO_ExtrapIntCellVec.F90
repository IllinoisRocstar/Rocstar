...
!******************************************************************************
!
! $Id: RFLO_ExtrapIntCellVec.F90,v 1.3 2008/12/06 08:44:06 mtcampbe Exp $
!
...
!******************************************************************************
  ...
  RCSIdentString = '$RCSfile: RFLO_ExtrapIntCellVec.F90,v $'

  global => region%global
  CALL RegisterFunction( global,'RFLO_ExtrapIntCellVec',&
    ...
    DO iDum=2,nDum 
      ...
      DO k=kbeg,kend
        DO j=jbeg,jend
          ...
          DO l=idBeg,idEnd
            fVec(l,ijkC0) = 2._RFREAL*fVec(l,ijkC1)-fVec(l,ijkC2) 
            fVec(l,ijkC)  = fVec(l,ijkC0)+fVec(l,ijkC1)-fVec(l,ijkC3) 
          ENDDO ! l
        ENDDO   ! j
      ENDDO     ! k
    ENDDO       ! iDum
...
!
! $Log: RFLO_ExtrapIntCellVec.F90,v $
