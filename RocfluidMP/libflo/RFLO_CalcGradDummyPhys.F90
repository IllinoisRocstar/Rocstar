...
!******************************************************************************
!
! Purpose: copy gradients at the patch to the dummy points  
!          for physical boundary conditions
!
! Description: dummy gradients copied from interior
!
...
!******************************************************************************
!
! $Id: RFLO_CalcGradDummyPhys.F90,v 1.3 2008/12/06 08:44:06 mtcampbe Exp $
!
! Copyright: (c) 2001 by the University of Illinois
!
!******************************************************************************

SUBROUTINE RFLO_CalcGradDummyPhys( region,lbound, &
                                   idir  ,jdir  ,kdir  , &
...
!******************************************************************************
  ...
  CALL RegisterFunction( region%global,'RFLO_CalcGradDummyPhys',&
...
! 
! $Log: RFLO_CalcGradDummyPhys.F90,v $
...
! Some more clean up.
!
! Revision 1.2  2002/07/19 23:43:35  wasistho
