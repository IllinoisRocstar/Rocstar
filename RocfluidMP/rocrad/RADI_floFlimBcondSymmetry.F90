...
!******************************************************************************
!
! Purpose: update FLD radiation variables in dummy cells at boundary patch 
!          assuming scalar symmetry between variables at interior and dummy 
!          cells.
!
! Description: none.
!
...
!        patch  = current patch.
!
! Output: region%levels%radi%cv = FLD radiation variables in dummy cells.
!
! Notes: none.
!
!******************************************************************************
!
! $Id: RADI_floFlimBcondSymmetry.F90,v 1.3 2008/12/06 08:44:38 mtcampbe Exp $
!
...
!
! $Log: RADI_floFlimBcondSymmetry.F90,v $
