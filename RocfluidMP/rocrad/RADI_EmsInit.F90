...
!******************************************************************************
!
! Purpose: set initial Radiation solution field or parameters at 1st EMSstg. 
!
! Description: none.
!
...
!******************************************************************************
!
! $Id: RADI_EmsInit.F90,v 1.3 2008/12/06 08:44:37 mtcampbe Exp $
!
! Copyright: (c) 2003 by the University of Illinois
!
!******************************************************************************

SUBROUTINE RADI_EmsInit( region, istage ) ! PUBLIC
  ...
  USE RADI_ModInterfaces, ONLY : RADI_ExtinctionCoef, RADI_CalcEffTemp, &
                                 RADI_FluxLimiter, RADI_FlimEmsInit
  IMPLICIT NONE
...
! which model -----------------------------------------------------------------
  ...
  IF (region%radiInput%radiModel == RADI_MODEL_FLDTRAN) THEN
    CALL RADI_FlimEmsInit( region, iStage )
  ENDIF
