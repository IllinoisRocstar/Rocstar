...
!******************************************************************************
!
! Purpose: added radiation source terms to the rhs of fluid Energy eq.
!
! Description: see formulation of FLD (Howell et al. JCP 184 (2003) 53-78)
!
! Input: region = data of current region,
!
! Output: region%levels%mixt%rhs, radiaton source terms added to mixture rhs
!
! Notes: none.
!
!******************************************************************************
!
! $Id: RADI_MixtSourceTermsFlim.F90,v 1.3 2008/12/06 08:44:37 mtcampbe Exp $
!
...
! ----- src term = bbSourceAlp-planckAlp*c*Er ! bbSourceAlp=planckAlp*bTermAlp
        ...
        bTermAlp  = fourStb*dv(DV_MIXT_TEMP,ijkC)**4
        sTerm = bTermAlp - dv(DV_MIXT_SOUN,ijkC)*rcv(CV_RADI_ENER,ijkC)
        sTerm = planckAlp*sTerm

        rhs(CV_MIXT_ENER,ijkC) = rhs(CV_MIXT_ENER,ijkC) - vol(ijkC)*sTerm
...
!
! $Log: RADI_MixtSourceTermsFlim.F90,v $
