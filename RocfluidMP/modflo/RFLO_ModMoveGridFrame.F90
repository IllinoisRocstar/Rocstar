...
! ******************************************************************************
!
! $Id: RFLO_ModMoveGridFrame.F90,v 1.75 2009/08/27 14:04:50 mtcampbe Exp $
!
...
! ******************************************************************************  
  ...
  CHARACTER(CHRLEN) :: RCSIdentString = & 
    '$RCSfile: RFLO_ModMoveGridFrame.F90,v $ $Revision: 1.75 $'        
...
1000 FORMAT(A,1X,'Global-TFI grid motion:', &
            2I5,4(1PE9.2),I4,3(1PE9.2))
2000 FORMAT(A,1X,'Global-Weighted-Laplacian grid motion:', &
            2I5,4(1PE9.2),I4,3(1PE9.2),1PE13.4)
3000 FORMAT(A,1X,'Global-Orthogonal-Laplacian gridmotion:', &
            2I3,4(1PE9.2),I4,3(1PE9.2),3(1PE9.2),1PE10.2)
      ...
      DO iPatch=1,regions(iReg)%nPatches
        ...
        DO ipCorn = 1,4    ! patch corners
          ...
          IF (grid%nCorns(iReg) >= ncMax) THEN
            CALL ErrorStop( global,ERR_ILLEGAL_VALUE,&
                 __LINE__, &
...
!            grid%regCorn(:,ico,iReg) = grid%regCorn(:,ico,iReg) + &
!                                       orthWg(:)*shift(:)/grid%nshared(ico)
            grid%regCorn(:,ico,iReg) = (1._RFREAL-orthWg(:))* &
                                       grid%regCorn(:,ico,iReg) + &
                                       orthWg(:)*shift(:)/kf
          ENDIF  ! ABS(shift)
...
!
! $Log: RFLO_ModMoveGridFrame.F90,v $
! Revision 1.75  2009/08/27 14:04:50  mtcampbe
! Updated to enable burning motion with symmetry boundaries and enhanced
! burnout code.
!
! Revision 1.74  2008/12/06 08:44:16  mtcampbe
! Updated license.
!
! Revision 1.73  2008/11/19 22:17:27  mtcampbe
! Added Illinois Open Source License/Copyright
!
! Revision 1.72  2006/03/18 13:25:41  wasistho
! added orthDir and orthWghtX,Y,Z
!
! Revision 1.71  2006/03/18 11:03:14  wasistho
! screen printed global skewness and minvol
!
! Revision 1.70  2006/03/16 08:30:13  wasistho
! modified global skewness effect on orthowght
!
! Revision 1.69  2006/03/15 06:37:15  wasistho
! added region and global skewness
!
! Revision 1.68  2006/03/05 22:27:25  wasistho
! fixed syntax error
!
! Revision 1.67  2006/03/05 21:53:14  wasistho
! changed computational space coordinates to be based on initial grid
!
! Revision 1.17  2006/02/11 03:53:27  wasistho
! made some routines public
!
! Revision 1.16  2006/01/28 22:52:52  wasistho
! fixed iEdgeGlo
!
! Revision 1.15  2005/12/05 10:51:12  wasistho
! moved RFLO_NormCrossProd to RFLO_ModVectorTensor
!
! Revision 1.14  2005/11/16 22:56:19  wasistho
! update screen print moveGridFOMS
!
! Revision 1.13  2005/11/05 04:13:32  wasistho
! modified gridFrameSurface
!
! Revision 1.12  2005/11/05 01:05:27  wasistho
! modified orthoshift
!
! Revision 1.11  2005/11/01 01:18:22  wasistho
! increased tolerance in frameEdges
!
! Revision 1.10  2005/10/28 07:40:41  wasistho
! modified FORMAT 1000
!
! Revision 1.9  2005/10/28 02:53:20  wasistho
! modified mgFrameEdges
!
! Revision 1.8  2005/10/27 19:20:00  wasistho
! modified screen print
!
! Revision 1.7  2005/10/27 05:57:02  wasistho
! added MoveGridFoms
!
! Revision 1.6  2005/10/11 19:23:26  wasistho
! modified moveCorners routine
!
