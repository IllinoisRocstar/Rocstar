      SUBROUTINE read_tetmesh_cohin(numbc_prmry,numvertx2d,dhmin,nprocs)
...
c$$$C - cartesian coordinate of Nodes x, y, z
c$$$         WRITE(12,'(i10,3f16.9)') i,coor(1:3,i)
c$$$      ENDDO
c$$$
c$$$! matid fix it always = 1
c$$$      matid = 1
c$$$C
c$$$C --  Read element connectivity array
c$$$ 
...
c$$$
c$$$c         WRITE(12,'(7i10)') i, 0, matid, 
c$$$c     $        lmelv_prmry(1,i),lmelv_prmry(2,i),lmelv_prmry(4,i),lmelv_prmry(3,i)
c$$$
c$$$         WRITE(12,'(7i10)') i, 0, matid, 
c$$$     $        lmelv_prmry(1:4,i)
c$$$      ENDDO
c$$$
